...
source('/homes/elineb/gf/resource_tracking/prep/shared_prep_functions.R', encoding = "UTF-8")
...
raw_cod_data = fread(paste0(dir, "resource_tracking/cod/prepped/raw_bound_gf_files.csv"), encoding = "Latin-1")
raw_gtm_data = fread(paste0(dir, "resource_tracking/gtm/prepped/raw_bound_gf_files.csv"), encoding = "Latin-1")
raw_uga_data = fread(paste0(dir, "resource_tracking/uga/prepped/raw_bound_gf_files.csv"), encoding = "Latin-1")
...
cod_filelist = fread(paste0(dir, "resource_tracking/cod/grants/cod_budget_filelist.csv"), encoding = "Latin-1")
gtm_filelist = fread(paste0(dir, "resource_tracking/gtm/grants/gtm_budget_filelist.csv"), encoding = "Latin-1")
uga_filelist = fread(paste0(dir, "resource_tracking/uga/grants/uga_budget_filelist.csv"), encoding = "Latin-1")
...
post_2017_map = fread(paste0(dir, "mapping/multi_country/intervention_categories/post_2017_map.csv"), encoding = "Latin-1")
...
write.csv(training_data1, paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/nlp_training_budgetpudr_all.csv"))
...
write.csv(training_data2_fr, paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/nlp_training_budgetpudr_french.csv"))
write.csv(training_data2_esp, paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/nlp_training_budgetpudr_spanish.csv"))
write.csv(training_data2_eng, paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/nlp_training_budgetpudr_english.csv"))

#------------------------------------------------------
# 3. Training data based on observations we've coded by hand. 
#--------------------------------------------------------
initial_training = fread(paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/nlp_training_sample.csv"), encoding = "Latin-1")
...
iteration2 = fread(paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/model_outputs/iteration2/iteration2.csv"), encoding = "Latin-1")
iteration2 = iteration2[, .(corrected_module, corrected_intervention, sda_activity, disease_lang_concat)]

iteration3 = fread(paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/model_outputs/iteration3/iteration3.csv"), encoding = "Latin-1")
iteration3 = iteration3[, .(corrected_module, corrected_intervention, sda_activity, disease_lang_concat)]

iteration4 = fread(paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/model_outputs/iteration4/iteration4.csv"), encoding = "Latin-1")
iteration4 = iteration4[, .(corrected_module, corrected_intervention, sda_activity, disease_lang_concat)]

# iteration5 = fread(paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/model_outputs/iteration5/iteration5.csv"), encoding = "Latin-1")
...
codes = fread(paste0(dir, "mapping/multi_country/intervention_categories/all_interventions.csv"), encoding = "Latin-1")
setnames(codes, old=c('Module', 'Intervention', 'Code'), new=c('module', 'intervention', 'code'))
...
training_data3 = training_data3[, .(module, intervention, disease, sda_activity, lang, code)] #We don't have loc_name here - we could guess but let's leave it for now. 
training_data3 = training_data3[!is.na(code)] #Drop these out for now- N = 1
write.csv(training_data3, paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/nlp_training_handcoded_all.csv"))
...
write.csv(training_data4, paste0(dir, "resource_tracking/multi_country/mapping/nlp_data/budgetpudr_with_extra_codes.csv"))
...
for(dt in all_training) {
  # dt.name = deparse(substitute(dt))
  # print(paste0("Dataset: ", dt.name))

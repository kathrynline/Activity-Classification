...
from googletrans_fix import urls, utils
from googletrans_fix.adapters import TimeoutAdapter
from googletrans_fix.compat import PY3
from googletrans_fix.gtoken import TokenAcquirer
from googletrans_fix.constants import DEFAULT_USER_AGENT, LANGCODES, LANGUAGES, SPECIAL_CASES
from googletrans_fix.models import Translated, Detected
...
class Translator(object):
    ...
    def translate(self, text, dest='en', src='auto'):
        ...
        :param dest: The language to translate the source text into.
                     The value should be one of the language codes listed in :const:`googletrans_fix.LANGUAGES`
                     or one of the language names listed in :const:`googletrans_fix.LANGCODES`.
        ...
        Basic usage:
            >>> from googletrans_fix import Translator
